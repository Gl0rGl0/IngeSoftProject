...
public class SetupPhaseTests {
    ...
    public void testSetupSetAmbitoFailAfterSetupComplete() {
         ...
         controller.interpreterSETUP("setmax 5"); // Correct setup command
    ...
    //     // Act
    //     controller.interpreterSETUP("setmax 0"); // Correct setup command
    ...
    //     // Act
    //     controller.interpreterSETUP("setmax -1"); // Correct setup command
    ...
    //      // Act
    //      controller.interpreterSETUP("setmax five"); // Correct setup command
    ...
    //       controller.interpreterSETUP("setmax 10"); // Correct setup command (should fail)
    ...
    //     controller.interpreterSETUP("setmax 10");
