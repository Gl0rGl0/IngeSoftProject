...
public class LoginTests {
    ...
    private void resetDataFiles() {
        ...
        // We might need a minimal completed setup state for add commands to work
        // TODO: Add minimal setup data (ambito, personeMax, done flag) if required by 'add' command
    }

    @BeforeEach
    public void setup() {
        resetDataFiles();
        // Default ADMIN/PASSWORD user is usually created implicitly by Model/Controller
        // Log in as ADMIN to be able to add other users for tests
        controller.interpreter("login ADMIN PASSWORD");
        // It's possible ADMIN also needs password change first, handle if necessary
