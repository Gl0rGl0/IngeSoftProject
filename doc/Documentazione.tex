...
% --- UC V4-01: Login Esteso (Configuratore/Volontario/Fruitore) ---
\begin{longtable}{@{} p{0.2\textwidth} p{0.75\textwidth} @{}}
\toprule
\rowcolor{lightgray}
...
% --- UC V4-02: Cambio Password (Esteso a Fruitore) ---
\newpage
\begin{longtable}{@{} p{0.2\textwidth} p{0.75\textwidth} @{}}
\toprule
\rowcolor{lightgray}
...
% --- UC V4-03: Cambio Password Obbligatorio (Esteso a Fruitore) ---
\newpage
\begin{longtable}{@{} p{0.2\textwidth} p{0.75\textwidth} @{}}
\toprule
\rowcolor{lightgray}
...
% --- UC V4-04: Menu a Regime Fruitore ---
\newpage
\begin{longtable}{@{} p{0.2\textwidth} p{0.75\textwidth} @{}}
\toprule
\rowcolor{lightgray}
...
% --- UC V4-05: Visualizza Visite Pubbliche ---
\newpage
\begin{longtable}{@{} p{0.2\textwidth} p{0.75\textwidth} @{}}
\toprule
\rowcolor{lightgray}
...
\begin{enumerate}[leftmargin=*]
    ...
    \item Il fruitore inserisce il numero di persone.
    \item Il sistema valida:
        \begin{itemize}
            \item La visita identificata esiste ed è nello stato "proposta".
            \item Il numero di persone è >= 1 e <= al massimo consentito per singola iscrizione.
            \item L'aggiunta di questo numero di persone non supera il numero massimo di partecipanti per quel tipo di visita.
        \end{itemize}
    \item La validazione ha successo. Il sistema registra l'iscrizione associandola allo username del fruitore e al numero di persone.
    \item Il sistema genera e restituisce al fruitore un codice di prenotazione univoco.
    \item Il sistema aggiorna il numero di iscritti alla visita. Se il numero massimo di partecipanti è raggiunto, lo stato della visita passa a "completa".
    \item Il sistema conferma l'iscrizione e mostra il codice di prenotazione.
\end{enumerate} \\
\midrule
\textbf{\makecell[l]{Scenario\\Alternativo}} & \textbf{3.a}: La visita identificata non esiste o non è in stato "proposta". Errore, torna al passo 2. \\ \addlinespace
                 & \textbf{6.a}: Il numero di persone non è valido (fuori range 1..max\_per\_iscrizione). Errore, torna al passo 4. \\ \addlinespace
                 & \textbf{6.b}: L'iscrizione supererebbe il numero massimo di partecipanti per la visita. Errore (es. "Posti non sufficienti"), torna al passo 4. \\
\midrule
\textbf{Postcondizioni} &
\begin{itemize}[leftmargin=*]
    \item L'iscrizione è registrata nel sistema con un codice univoco.
    \item Il numero di iscritti alla visita è aggiornato.
    \item Lo stato della visita può cambiare da "proposta" a "completa".
    \item Il fruitore torna al menu a regime.
\end{itemize} \\
\bottomrule
\caption{UC V4-06: Iscrizione a Visita} \label{uc:v4-06}
\end{longtable}

% --- UC V4-07: Visualizza Iscrizioni Personali ---
\newpage
\begin{longtable}{@{} p{0.2\textwidth} p{0.75\textwidth} @{}}
\toprule
\rowcolor{lightgray}
...
% --- UC V4-09: Visualizza Visite Assegnate (Volontario) ---
\newpage
\begin{longtable}{@{} p{0.2\textwidth} p{0.75\textwidth} @{}}
\toprule
\rowcolor{lightgray}
